# Schema 3.0.1 dataset guidance

This document records the agreed interpretation of schema 3.0.1 dataset metadata. It is a working source for future user documentation while version 3.0.1 remains in development.
