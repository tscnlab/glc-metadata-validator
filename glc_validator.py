...
SCHEMA_3_VERSIONS = {"3.0.0", "3.0.1", "3.0.2"}
...
def validate_crossrefs(datapackage_path: str):
    ...
    if package: 
        ...
        if schema_version:
            ...
            allowed_profiles.add(profile_filename)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate GLC Data Package cross-references and nested schemas.")
